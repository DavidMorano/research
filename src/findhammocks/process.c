...
/******************************************************************************
	...
	In this subroutine we find the Sinple Single-sided Hammock
	conditional branches and we catalog them.
