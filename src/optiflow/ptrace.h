...
#define PEV_CHKERROR		0x00000020	/* checker error detected */
#define PEV_BSPECMISS		0x00000040	/* blind speculation miss */
...
#define ptrace_check_active(PC, ICNT, CYCLE)	/* NADA */
#define	ptrace_newinst(A,B,C,D)			/* NADA */
#define ptrace_newuop(A,B,C,D)			/* NADA */
#define ptrace_endinst(A)			/* NADA */
#define ptrace_newcycle(A)			/* NADA */
#define ptrace_newstage(A,B,C)			/* NADA */
#define ptrace_active(A,I,C)			/* NADA */
