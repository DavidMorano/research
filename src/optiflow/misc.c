...
/* verbose registers output flag */
int verbose_regs = FALSE;

/* trigger instruction */
unsigned int trigger_inst = 0;
...
#define HIBITL		MKLL(0x8000000000000000)
...
#define LL_MAX		MKLL(9223372036854775807)
#define LL_MIN		(-LL_MAX - 1)
#define ULL_MAX		(MKULL(9223372036854775807) * MKULL(2) + 1)
...
/* convert a string to an unsigned result */
qword_t
