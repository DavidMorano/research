...
enum opt_class_t {
  ...
  oc_sqword,		/* signed quad option */
  oc_qword,		/* unsigned quad option */
  oc_NUM
};
...
struct opt_opt_t {
  ...
  union opt_variant_t {
    ...
    /* oc == oc_counter */
    struct opt_for_qword_t {
      qword_t	*var;			/* pointer to integer option */
    } for_qword ;

    /* oc == oc_counter */
    struct opt_for_sqword_t {
      sqword_t	*var;			/* pointer to integer option */
    } for_sqword ;
...
/* register an LONG (long64) integer option variable */
void
opt_reg_sqword(struct opt_odb_t *odb,	/* option database */
	    char *name,			/* option name */
	    char *desc,			/* option description */
	    sqword_t	*var,			/* pointer to option variable */
