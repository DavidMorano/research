 ...
 *
 * $Id: libexo.c,v 1.1.1.1 2000/07/09 15:57:36 saugatac Exp $
 *
 * $Log: libexo.c,v $
 * Revision 1.1.1.1  2000/07/09 15:57:36  saugatac
 * Imported Sim-mutilator Sources
 *
 * Revision 1.2  1999/12/31 18:54:50  taustin
