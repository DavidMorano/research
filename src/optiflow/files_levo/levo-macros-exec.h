/* levo-macros-exec.h - sim-mase macros for the execute stage */
...
#ifndef	LEVOMACROSEXEC_INCLUDE
#define	LEVOMACROSEXEC_INCLUDE	1
...
#define WRITE_QWORD(DATA, ADDR, FAULT)				\
  __WRITE_SPECMEM(MD_SWAPQ(DATA), (ADDR), 8, (FAULT));



#endif /* LEVOMACROSEXEC_INCLUDE */
