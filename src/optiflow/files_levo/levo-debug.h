/* levo-debug.h - debug routines for sim-mase */
...
#ifndef	LEVODEBUG_INCLUDE
#define	LEVODEBUG_INCLUDE	1



/* default memory state accessor, used by DLite */
char *					/* err str, NULL for no err */
levo_mem_obj(struct mem_t *mem,		/* memory space to access */
...
char *					/* err str, NULL for no err */
levo_reg_obj(struct regs_t *regs,	/* registers to access */
	    int is_write,		/* access type */
...
char *					/* err str, NULL for no err */
levo_mstate_obj(FILE *stream,		/* output stream */
