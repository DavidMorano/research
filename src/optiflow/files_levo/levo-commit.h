/* levo-commit.h - sim-mase commit stage */
...
#ifndef	LEVOCOMMIT_INCLUDE
#define	LEVOCOMMIT_INCLUDE	1



/* Clears out invalid blind speculation recoveries resulting from a current
 * recovery. */
void
blind_spec_recover(void);
