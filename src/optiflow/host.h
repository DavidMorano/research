...
/* qword defs, note: not all targets support qword types */
	...
	defined(__CC_C89) || defined(__CC_XLC)

#define HOST_HAS_QWORD		1
typedef unsigned long long qword_t;	/* qword - 64 bits */
typedef signed long long sqword_t;

#ifdef ANSI_SYMCAT
#define MKULL(N)		N##ULL		/* qword_t constant */
#define MKLL(N)		N##LL		/* sqword_t constant */
#else /* OLD_SYMCAT */
#define MKULL(N)		N/**/ULL	/* qword_t constant */
#define MKLL(N)		N/**/LL		/* sqword_t constant */
#endif
...
#ifdef ANSI_SYMCAT
#define MKULL(N)		N##UL		/* qword_t constant */
#define MKLL(N)		N##L		/* sqword_t constant */
#else /* OLD_SYMCAT */
#define MKULL(N)		N/**/UL		/* qword_t constant */
#define MKLL(N)		N/**/L		/* sqword_t constant */
#endif
...
#define MKULL(N)		((qword_t)(N))
#define MKLL(N)		((sqword_t)(N))
