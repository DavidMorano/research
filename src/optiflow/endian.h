...
#define SWAP_QWORD(X)	(((qword_t)(X) << 56) |				\
			 (((qword_t)(X) << 40) & MKULL(0x00ff000000000000)) |\
			 (((qword_t)(X) << 24) & MKULL(0x0000ff0000000000)) |\
			 (((qword_t)(X) << 8)  & MKULL(0x000000ff00000000)) |\
			 (((qword_t)(X) >> 8)  & MKULL(0x00000000ff000000)) |\
			 (((qword_t)(X) >> 24) & MKULL(0x0000000000ff0000)) |\
			 (((qword_t)(X) >> 40) & MKULL(0x000000000000ff00)) |\
			 (((qword_t)(X) >> 56) & MKULL(0x00000000000000ff)))
