...
int ldecode_decode(LDECODE *current_instr) 
{
  ...
  current_instr->src3 = (uint) -1;
  current_instr->src4 = (uint) -1;
  current_instr->dst1 = RD_(instr);
  current_instr->dst2 = (uint) -1;
  current_instr->const1 = (uint) -1;
...
#ifdef	COMMENT
      printf("\nldecode_fpd_op: Invalid instruction format, "
		"unimplemented instruction\n");
#endif /* COMMENT */
