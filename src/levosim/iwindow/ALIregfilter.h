...
#define	REGFILTER_ARGS	struct regfilter_a
...
struct regfilter_sflags {
	...
	uint	fownbus : 1 ;		/* forward is currently owned */
...
extern int regfilter_init(REGFILTER *,struct proginfo *,struct mintinfo *,
	struct levoinfo *,REGFILTER_ARGS *) ;
extern int regfilter_initval(REGFILTER *,int,int,uint) ;
...
extern int regfilter_pathcopy(REGFILTER *,REGFILTER *,int) ;
extern int regfilter_setval(REGFILTER *,int,int,uint) ;
extern int regfilter_getval(REGFILTER *,int,int,uint *) ;
extern int regfilter_getfg(REGFILTER *,int,int,LFLOWGROUP *) ;
extern int regfilter_settt(REGFILTER *,int) ;
extern int regfilter_update(REGFILTER *,REGFILTER *) ;
