...
/* revision history:
   ...
   = 00/06/17, Efe Yardimci
     This object was originally written.

   = 00/06/23
   Marcos R de Alba
   Completed MIPS Instructions Set and corrected right implementation of
   instructions.
...
/* Definitions for Compare Instructions.
   ...
   */
/* Do not take trap */
#define LEXECOP_CMPFD     0x80 
#define LEXECOP_CMPFS     0x90
#define LEXECOP_CMPUND    0x81
#define LEXECOP_CMPUNS    0x91 
#define LEXECOP_CMPEQD    0x82 
#define LEXECOP_CMPEQS    0x92
#define LEXECOP_CMPUEQD   0x83
#define LEXECOP_CMPUEQS   0x93
#define LEXECOP_CMPOLTD   0x84
#define LEXECOP_CMPOLTS   0x94 
#define LEXECOP_CMPULTD   0x85 
#define LEXECOP_CMPULTS   0x95 
#define LEXECOP_CMPOLED   0x86 
#define LEXECOP_CMPOLES   0x96 
#define LEXECOP_CMPULED   0x87 
#define LEXECOP_CMPULES   0x97

/* Do take trap */ 
#define LEXECOP_CMPSFD    0x88
#define LEXECOP_CMPSFS    0x98
#define LEXECOP_CMPNGLED  0x89 
#define LEXECOP_CMPNGLES  0x99 
#define LEXECOP_CMPSEQD   0x8a 
#define LEXECOP_CMPSEQS   0x9a 
#define LEXECOP_CMPNGLD   0x8b 
#define LEXECOP_CMPNGLS   0x9b 
#define LEXECOP_CMPLTD    0x8c  
#define LEXECOP_CMPLTS    0x9c 
#define LEXECOP_CMPNGED   0x8d 
#define LEXECOP_CMPNGES   0x9d 
#define LEXECOP_CMPLED    0x8e 
#define LEXECOP_CMPLES    0x9e   
#define LEXECOP_CMPNGTD   0x8f 
#define LEXECOP_CMPNGTS   0x9f 

#define LEXECOP_CVTDS     62 /* Convert Single To Double  */
#define LEXECOP_CVTDW     63 /* Convert Integer To Double  */
#define LEXECOP_CVTSD     64 /* Convert Double To Single */
#define LEXECOP_CVTSW     65 /* Convert Integer To Single  */
#define LEXECOP_CVTWD     66 /* Convert Double To Integer */  
#define LEXECOP_CVTWS     67 /* Convert Single To Integer */  
...
#define LEXECOP_CTC0      93
#define LEXECOP_CTC1      94
#define LEXECOP_LDC0      95
