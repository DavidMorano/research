...
#ifndef LEXECOP_INCLUDE
#define LEXECOP_INCLUDE	1
...
#define LEXECOP_SLLV	15	/* Shift Left Logical (value)		*/
#define LEXECOP_SRA	16	/* Shift Register Arithmetic		*/
#define LEXECOP_SRAV	17	/* Shift Register Arithmetic (value)	*/
#define LEXECOP_SRL	18	/* Shift Right Logical		*/
#define LEXECOP_SRLV	19	/* Shift Right Logical (value)	*/
...
#define LEXECOP_CVTDW		63 /* Convert fixed to double precision */
#define LEXECOP_CVTSD		64 /* Convert double to single precision */
#define LEXECOP_CVTSW		65 /* Convert fixed to single precision */
#define LEXECOP_CVTWS		66 /* Convert single precision to fixed */  
#define LEXECOP_CVTWD		67 /* Convert double precision to fixed */
...
/* finally, the unimplemented instruction code ! */

#define	LEXECOP_UNIMPL	170

/* total number of instruction operations */

#define	LEXECOP_TOTAL	171


#endif /* LEXECOP_INCLUDE */
