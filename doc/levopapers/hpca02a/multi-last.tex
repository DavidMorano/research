...
large distributed microarchitecture.  Most work on multipath
execution has been done in the context of its applicability
to processor
microarchitectures that fairly closely resemble those
being commercially explored today.
Not much work has been done on implementing multipath execution
on more aggressive large-scale microarchitectures that
can speculatively execute possibly up to several hundreds
of instructions simultaneously.
We believe that both larger microarchitectures and
multipath execution will be necessary to get higher single
threaded program execution performance.
For microarchitectures that allow for very
...
hundreds or more instructions down a single speculative path.
...
Table /ref{tab:table1} shows the statistics for each benchmark.  
Table /ref{tab:table2} shows something else.

\begin{table}
\begin{center}
\caption{Benchmarks Analyzed and Some Statistics.}\label{tab:table1}
\begin{tabular}{|c|c|c|c|c|c|}
\hline 
 & parser & go & bzip & gap & gzip \\
\hline 
\hline 
HPNF & 6.14 & 1.89 & 16.38 & 8.96 & 8.80 \\
\hline 
HPNB & 0.65 & 0.23 & 3.39 & 0.85 & 0.93 \\
\hline 
HUNF & 2.27 & 10.66 & 14.12 & 2.03 & 7.87 \\
\hline 
HUNB & 0.96 & 2.35 & 1.69 & 0.59 & 1.85 \\
\hline 
HPDF & 0.25 & 0.06 & 1.13 & 0.53 & 0.00 \\
\hline 
HPDB & 0.05 & 0.06 & 1.13 & 0.00 & 0.46 \\
\hline 
HUDF & 0.00 & 0.63 & 0.00 & 0.11 & 0.00 \\
\hline 
HUDB & 0.05 & 0.31 & 0.00 & 0.00 & 0.00 \\
\hline 
L*** & 89.63 & 83.82 & 62.15 & 86.93 & 80.09 \\
\hline 
executed Branches & 1986 & 5242 & 177 & 1875 & 216 \\
\hline 
\end{tabular}
\end{center}
\end{table}
...
\begin{table}
\begin{center}
\caption{Benchmarks Analyzed and Some Statistics.}\label{tab:table2}
\begin{tabular}{|c|c|c|c|c|c|}
\hline 
 & parser & go & bzip & gap & gzip \\
\hline 
\hline 
HPNF & 66.43 & 14.04 & 43.23 & 41.66 & 23.61 \\
\hline 
HPNB & 4.98 & 2.35 & 11.07 & 25.50 & 5.90 \\
\hline 
HUNF & 8.65 & 55.87 & 26.53 & 11.12 & 39.60 \\
\hline 
HUNB & 8.33 & 12.82 & 6.98 & 9.59 & 19.67 \\
\hline 
HPDF & 1.30 & 0.24 & 1.61 & 1.86 & 0.00 \\
\hline 
HPDB & 0.17 & 0.28 & 0.97 & 0.00 & 1.39 \\
\hline 
HUDF & 0.00 & 2.30 & 0.00 & 0.28 & 0.00 \\
\hline 
HUDB & 0.17 & 2.11 & 0.00 & 0.00 & 0.00 \\
\hline 
L*** & 2.51 & 18.43 & 0.03 & 4.76 & 0.04 \\
\hline 
Dynamic Branches & 69M &  62M & 38M & 33M & 52M \\
\hline 
\end{tabular}
\end{center}
\end{table}
...
The six machine configurations simulated are given 
in Table \ref{tab:configs}.

\begin{table}
\begin{center}
\caption{Machine configurations simulated for each of the benchmarks
programs.}
\label{tab:configs}
\begin{tabular}{|c|c|c|c|}
\hline 
