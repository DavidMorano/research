...
%
%
% uncomment the following to make all pages have no page numbers
%\pagestyle{empty}
%
%
\begin{document}
...
%
% make date blank for submission to make publications
\date{}
%
\maketitle
%
% uncomment the following for a first page with no page numbers (for IEEE)
%\thispagestyle{empty}
%
%
\begin{abstract}
