...
\noindent
{\Large Technical Report No.\ 032002-0103}
\vspace{0.30in}
...
\begin{figure}
\centering
\epsfig{file=disjoint.eps,width=5.8in}
...
%\vspace{0.2 in}
%\setlength{\epsfxsize}{10cm}%7
%\centerline{\epsfbox{ipc.eps}}
\centering
\epsfig{file=ipc.eps,width=5.8in}
...
%\centerline{\epsfbox{ipcs.eps}}
\centering
\epsfig{file=ipcs.eps,width=5.8in}
